...
<asp:Content ID="Content2" runat="server" contentplaceholderid="cpMainContent">
    ...
    <asp:TextBox ID="HoeveelheidPersoon" runat="server"></asp:TextBox>
    ...
    <asp:Button ID="Bereken" runat="server" Text="Bereken" />
    <asp:Label ID="Totaal" runat="server" Text="Totaal:"></asp:Label>
    <asp:Label ID="Bedrag" runat="server" Text=""></asp:Label>
    <asp:Button ID="RekenAf" runat="server" Text="Reken af" />
